            ...
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <select name="is_trial" id="" class="form-select {{$errors->has('is_trial') ? 'is-invalid' : ''}}">
                        <option value="0" {{old('is_trial') == 0 ? 'selected' : ''}}>Không</option>
             ...
             <div class="col-4">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control {{$errors->has('position') ? 'is-invalid' : ''}}"
                        placeholder="Thứ tự bài giảng..." name="position" id="" value="{{old('position', $position)}}" />
                    @error('position')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <div class="input-group {{$errors->has('video') ? 'is-invalid' : ''}}">
                        ...
                        name="video" id="video-url"  value="{{old('video')}}" disabled/>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <div class="input-group {{$errors->has('document') ? 'is-invalid' : ''}}">
                        ...
                        name="document" id="document-url" value="{{old('document')}}" disabled/>
